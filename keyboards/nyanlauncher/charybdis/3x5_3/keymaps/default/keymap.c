...
// 3D LT() Aliases
//#define 3D1(kc) LT(_3D1, kc)
//#define 3D2(kc) LT(_3D2, kc)
//#define 3D3(kc) LT(_3D3, kc)
...
enum charybdis_keymap_layers {
    ...
    _GMG3,// function keys
    //_3D,// for work w/ Blender and Fusion
    //_3D1,
    //_3D2,
    //_3D3,
...
// TODO:
// - allow spc and ctl to be held in gaming layers
//   - when pressed timer starts, if another key isnt pressed, it continues to act like spc/ctl
// - fix mouse layer timeouts
// - create layers for doing 3D work
...
LT(_GMG1,KC_ESC),LT(_GMG2,KC_SPC),LT(_GMG3,KC_LCTL),     KC_ESC, MT(MOD_RSFT,KC_ENT), TO(_DEFAULT)
  ...
  */
  ...
  [_NAV] = LAYOUT(
  // ╭────────────────────────────────────────────────────╮ ╭──────────────────────────────────────────────╮
       TG(_DVORAK), LCS_TAB,  KC_UP, LCTL_TAB, LCTL_PLUS,     KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX, XXXXXXX,
  // ├────────────────────────────────────────────────────┤ ├──────────────────────────────────────────────┤
